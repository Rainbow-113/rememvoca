// lib/Shares/create_word_dialog.dart
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:rememvoca/Model/word_model.dart';
import 'package:rememvoca/Provider/word_pro.dart';

void showCreateWordDialog(BuildContext context, String folderId) {
  final englishController = TextEditingController();
  final vietnameseController = TextEditingController();
  final exampleEnglishController = TextEditingController();
  final exampleVietnameseController = TextEditingController();
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: () async {
                          ...
                          await context.read<wordProvider>().createWord(newWord);
